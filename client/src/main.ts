...
const paint = (): void => {
	...
	frame = renderLens({ from: view.from, text: view.text, status: store.lensStatus(), mic: store.lensMic(), page: view.page, blank: dark, corners: store.lensCorners(), input: store.lensInput() });
	mark("companion");
